...
public class VCPKPSPublicSoap
{
    ...
    public VCPKPSPublicSoap(){}

    public VCPKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public VCPKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        VCPExtendedSoapSerializationEnvelope envelope= new VCPExtendedSoapSerializationEnvelope(VCPExtendedSoapSerializationEnvelope.VER11);
