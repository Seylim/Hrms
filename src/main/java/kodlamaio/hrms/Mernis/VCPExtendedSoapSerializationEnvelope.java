...
public class VCPExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(VCPDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new VCPStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static VCPDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static VCPDateTimeConverter dateTimeConverter = new VCPStandardDateTimeConverter();

    public VCPExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public VCPExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new VCPMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=VCPHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,VCPExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=VCPHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
